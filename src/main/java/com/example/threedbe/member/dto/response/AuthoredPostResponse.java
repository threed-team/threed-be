...
public record AuthoredPostResponse(
	...
	public static AuthoredPostResponse from(MemberPost memberPost, boolean isNew, boolean isHot) {

		return new AuthoredPostResponse(
			memberPost.getId(),
			memberPost.getTitle(),
